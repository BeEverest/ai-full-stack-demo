...
Revision ID: b0f464606e39
Revises: 
Create Date: 2026-04-19 22:37:29.897200
...
def upgrade() -> None:
    ...
    op.alter_column('contact_submissions', 'ip_address',
               existing_type=sa.CHAR(length=39),
               type_=sa.String(length=45),
               existing_nullable=True)
    op.alter_column('product_features', 'product_id',
               existing_type=sa.BIGINT(),
               type_=sa.Integer(),
               existing_nullable=False)
    op.drop_index(op.f('product_features_product_id_60f4c810'), table_name='product_features')
    op.alter_column('product_images', 'product_id',
               existing_type=sa.BIGINT(),
               type_=sa.Integer(),
               existing_nullable=False)
    op.drop_index(op.f('product_images_product_id_28ebf5f0'), table_name='product_images')
    op.alter_column('product_specs', 'product_id',
               existing_type=sa.BIGINT(),
               type_=sa.Integer(),
               existing_nullable=False)
    op.drop_index(op.f('product_specs_product_id_e0b114ea'), table_name='product_specs')
...
def downgrade() -> None:
    ...
    op.create_index(op.f('product_specs_product_id_e0b114ea'), 'product_specs', ['product_id'], unique=False)
    op.alter_column('product_specs', 'product_id',
               existing_type=sa.Integer(),
               type_=sa.BIGINT(),
               existing_nullable=False)
    op.create_index(op.f('product_images_product_id_28ebf5f0'), 'product_images', ['product_id'], unique=False)
    op.alter_column('product_images', 'product_id',
               existing_type=sa.Integer(),
               type_=sa.BIGINT(),
               existing_nullable=False)
    op.create_index(op.f('product_features_product_id_60f4c810'), 'product_features', ['product_id'], unique=False)
    op.alter_column('product_features', 'product_id',
               existing_type=sa.Integer(),
               type_=sa.BIGINT(),
               existing_nullable=False)
